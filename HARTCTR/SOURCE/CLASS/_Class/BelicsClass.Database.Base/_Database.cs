...
namespace BelicsClass.Database
{
    ...
    public class BL_Database
    {
        ...
        /// <returns></returns>
		public virtual string ConvertDateQuate_NonQuery(string sql)
		{
			string s = sql;
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
		public virtual string ConvertDateQuate(string sql)
		{
			if (dateQuoteFrom != "" && dateQuoteTo != "")
			{
        ...
        public bool Execute(string sql)
        {
            lock (this)
            {
				...
				sql = ConvertDateQuate_NonQuery(sql);
                //sql = sql.Replace(DateQuoteFrom, DateQuoteTo);
